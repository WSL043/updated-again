  ...
  return (
    <section className="lab-page">
      <header className="page-heading">
        <div><p>它怎么活着</p><h1>项目内部</h1><span>自动更新、签名、本地数据、聊天和版本短片分开运行。坏掉一块，不耽误其他部分。</span></div>
        <span className="workshop-number">{String(CAPABILITY_LIST.length).padStart(2, "0")}</span>
      </header>

      <div className="foundation-map">
        <article><span>01</span><div><small>账本</small><h2>签名账本</h2><p>公开版本都带哈希和签名，安装时会重新验证。</p></div></article>
        <article><span>02</span><div><small>本机</small><h2>安装与回滚</h2><p>安装前保存本地快照。自动安装可以关闭，最后一次安装可以回滚。</p></div></article>
        <article><span>03</span><div><small>聊天</small><h2>本地规则优先</h2><p>规则和社区语料留在本机；匿名云端失败会自己退回来。</p></div></article>
        <article><span>04</span><div><small>短片</small><h2>版本短片</h2><p>Remotion 按版本数据生成短片，并在点击播放后才加载。</p></div></article>
      </div>
      ...
      <section className="capability-section">
        <header><p>可更新项目</p><h2>更新目前能改什么</h2></header>
