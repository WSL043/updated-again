...
- 打开就能玩「补丁接线室」：3×3 / 4×4 / 5×5 每日同题与自由练习，最短解提示、撤销、刷新续玩和通关卡片。无需安装胶囊或连接账号。
- 「补丁混合台」把装过的变化变成 84 种可收集的实验状态，支持每日线索和本机图鉴。
...
当前版本是公开开发者预览，不是稳定版。项目故意不会急着宣布 `1.0`，但“不完成”不意味着可以跳过安全、真实性或回滚。
